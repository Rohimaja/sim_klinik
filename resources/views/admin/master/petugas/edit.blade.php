<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Master Data > Edit Petugas Rekamedis') }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-2xl">
                ...
                <div class="bg-[linear-gradient(to_bottom,#7134FC_0%,#2088FF_100%)] p-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-white">Edit Data Petugas Rekamedis</h3>
                            <p class="text-blue-100 text-sm">Perbaruhi Data Petugas Rekamedis dengan benar dan lengkap
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div x-data="{ editModal: false }">
                    <form action="#" method="POST" class="p-6 space-y-6" @submit.prevent="editModal = true">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" name="nama_lengkap" required
                                            ...
                                            placeholder="Contoh: Dr. Ahmad Fauzi, Sp.PD" value="Suster Rina Lestari">
                                    </div>
                                </div>
                                    ...
                                    <div class="flex gap-4">
                                        ...
                                        <label class="flex items-center gap-2 cursor-pointer">
                                            <input type="radio" name="jenis_kelamin" value="P" required
                                                class="w-4 h-4 text-pink-500 focus:ring-pink-500" checked>
                                            <span class="text-gray-700 dark:text-gray-300">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="email" name="email" required
                                            ...
                                            placeholder="contoh@hospital.com" value="SariLes@gmail.com">
                                    </div>
                                </div>
                        ...
                        <div class="border-l-4 border-purple-500 pl-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                                        No. STR (Surat Tanda Registrasi Perekam Medis) <span
                                ...
                                <div>
                                    ...
                                    <input type="text" name="no_sip" required
                                        class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                        placeholder="SIP-987654321-2024" value="SIk-987654321-2024">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="no_str" required
                                        class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                        placeholder="STR-123456789-2024" value="KTA-00123">
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="area_kerja" required
                                        ...
                                        <option value="Pendaftaran / TPPRJ">Pendaftaran / TPPRJ (Tempat Pendaftaran
                                            Pasien Rawat Jalan)</option>
                                        <option value="Filing dan Retensi">Filing dan Retensi (Penyimpanan Dokumen
                                            Rekam Medis)</option>
                                        <option value="Koding dan Indeksing" selected>Koding dan Indeksing (Klasifikasi
                                            Diagnosis dan Prosedur)</option>
                                        <option value="Pelaporan dan Statistik">Pelaporan dan Statistik Rekam Medis
                                        </option>
                                        <option value="Manajemen Unit RMIK">Manajemen Unit RMIK (Kepala Unit /
                                            Koordinator)</option>
                                        <option value="Verifikasi Klaim">Verifikasi Klaim (BPJS / Asuransi)</option>
                                        <option value="Assembling dan Analisis">Assembling dan Analisis Dokumen Rekam
                                            Medis</option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="jabatan" required
                                        ...
                                        <option value="Koordinator Koding dan Pelaporan">Koordinator Koding dan
                                            Pelaporan</option>
                                        <option value="Staf Pendaftaran">Staf Pendaftaran</option>
                                        <option value="Staf Filing">Staf Filing</option>
                                        <option value="Staf Koding ICD" selected>Staf Koding ICD</option>
                        ...
                        <div class="border-l-4 border-red-500 pl-4">
                            <h4
                                class="text-lg font-bold text-gray-800 dark:text-gray-200 mb-4 flex items-center gap-2">
                            ...
                            <div class="bg-teal-50 dark:bg-teal-900/20 p-4 rounded-lg">
                                <label class="flex items-center gap-3 cursor-pointer">
                                    ...
                                    <span class="text-gray-700 dark:text-gray-300 font-semibold">
                                        ...
                                        Aktifkan Petugas (Petugas dapat langsung bertugas)
                                    </span>
                                </label>
                            </div>
                        </div>
                        ...
                        <!-- Form Actions -->
                        <div
                            class="flex flex-col sm:flex-row items-center sm:justify-between pt-6 border-t border-gray-200 dark:border-gray-700 gap-3 sm:gap-0">
                            <!-- Tombol Kembali -->
                    ...
                    <div x-show="editModal" x-cloak x-transition:enter="transition ease-out duration-300"
                        ...
                        <div @click.outside="editModal = false"
                            ...
                            <!-- Header -->
                            <h2 class="text-2xl font-bold mb-3 text-blue-600 dark:text-blue-400 text-center">Konfirmasi
                                Edit</h2>

                            <!-- Content -->
                            <p class="text-gray-600 dark:text-gray-300 text-center mb-6">
                                Apakah Anda yakin ingin mengubah data Petugas<br>
                                <strong class="text-gray-800 dark:text-white text-lg">Darminto Joyon</strong>?
                            </p>
                            <p
                                class="text-sm text-gray-500 dark:text-gray-400 text-center mb-6 bg-yellow-50 dark:bg-yellow-900/20 p-3 rounded-lg border border-yellow-200 dark:border-yellow-800">
