            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-2xl">
                ...
                <div class="bg-[linear-gradient(to_bottom,#7134FC_0%,#2088FF_100%)] p-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-white">Edit Data Tindakan</h3>
                            <p class="text-blue-100 text-sm">Perbaruhi Data Tindakan dengan benar dan lengkap</p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="nama" required
                                        ...
                                        placeholder="Contoh: Pemeriksaan Umum" value="Pemeriksaan Umum">
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="kategori" required
                                        ...
                                        <option value="Tindakan Umum" selected>Tindakan Umum</option>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="tarif" min="0" required
                                        class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200"
                                        placeholder="Contoh: 50000" value="50000">
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="deskripsi" rows="3"
                                        class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200"
                                        placeholder="Contoh: Pemeriksaan dasar oleh dokter umum untuk keluhan umum pasien.">Pemeriksaan dasar oleh dokter umum untuk keluhan umum pasien</textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div x-show="editModal"
                        ...
                        <div @click.outside="editModal = false"
                            ...
                            <p class="text-gray-600 dark:text-gray-300 text-center mb-6">
                                Apakah Anda yakin ingin mengubah data obat<br>
                            </p>
