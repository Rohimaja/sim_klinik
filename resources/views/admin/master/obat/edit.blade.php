            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-2xl">
                ...
                <div class="bg-[linear-gradient(to_bottom,#7134FC_0%,#2088FF_100%)] p-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-white">Edit Data Obat</h3>
                            <p class="text-blue-100 text-sm">Perbaruhi Data Obat dengan benar dan lengkap</p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="nama_obat" required
                                        ...
                                        placeholder="Paracetamol 500mg" value="Paracetamol 500mg">
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="kategori" required
                                        ...
                                        <option value="Anti-Inflamasi" selected>Anti-Inflamasi</option>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="stok" min="0" required
                                        class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200"
                                        placeholder="Contoh: 100" value="150">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="harga" min="0" required
                                        class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200"
                                        placeholder="Contoh: 2000" value="2500"> 
                                </div>
                            </div>
                        </div>
