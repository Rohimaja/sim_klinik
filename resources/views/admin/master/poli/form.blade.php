    ...
    <div class="py-10">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-2xl">
                ...
                <!-- Form Content -->
                <form action="{{ isset($poli) ? route('admin.master-poli.update', $poli->id) : route('admin.master-poli.store') }}" method="POST" class="p-6 space-y-6">
                    @csrf
                    @if (isset($poli))
                        @method('PUT')
                    @endif
                    ...
                    <div class="border-l-4 border-purple-500 pl-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-1 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="nama" id="nama" value="{{ old('nama', $poli->nama ?? '') }}" required
                    ...
                    <div class="border-l-4 border-teal-500 pl-4">
                        ...
                        <div class="bg-teal-50 p-4 rounded-lg">
                            <label for="status" class="flex items-center gap-3 cursor-pointer">
                                ...
                                <input type="checkbox" name="status" id="status" value="1" {{ old('status', $poli->status ?? 0) == 1 ? 'checked' : '' }}
