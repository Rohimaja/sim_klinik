                        ...
                        <tbody class="text-gray-700">
                            ...
                            @foreach ($admin as $i => $a)
                                <tr class="border-b hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-3 sm:px-4 py-2">{{ $a->spesialisasi ?? '' }}</td>
                                    ...
                                    <td class="px-3 sm:px-4 py-2 text-center">
                                        <div class="flex justify-center gap-1 sm:gap-2">
                                            <!-- View Button -->
                                            <button @click="viewModal = true; $nextTick(() => loadDokterDetail({{ $a->id }}))"
                                            ...
                                            <!-- Delete Button -->
                                            <form action="{{ route('admin.master-dokter.destroy', $a->id) }}" method="POST" class="form-hapus">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
