                                    ...
                                    <tr class="border-b hover:bg-gray-50 transition">
                                        ...
                                        <td class="px-3 sm:px-4 py-2 text-center">
                                            <div class="flex justify-center gap-1 sm:gap-2">
                                                <!-- View Button -->
                                                <button @click="viewModal = true; $nextTick(() => loadAdminDetail({{ $a->id }}))"
                                                ...
                                                <!-- Delete Button -->
                                                <form action="{{ route('superadmin.master-admin.destroy', $a->id) }}" method="POST" class="form-hapus">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
                        ...
                        <div @click.away="viewModal = false"
                            ...
                            <div class="flex items-center justify-between p-6 pb-4 border-b-2 border-blue-500 bg-gradient-to-r from-blue-50 to-blue-100">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600 mt-1">Informasi lengkap data admin</p>
                                </div>
