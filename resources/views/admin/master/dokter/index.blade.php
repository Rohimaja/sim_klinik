                            ...
                            <tbody class="text-gray-700">
                                ...
                                @foreach ($dokter as $i => $d)
                                    <tr class="border-b hover:bg-gray-50 transition">
                                        ...
                                        <td class="px-3 sm:px-4 py-2 text-gray-600">{{ $d->user->nama ?? '' }}</td>
                                        ...
                                        <td class="px-3 sm:px-4 py-2 text-center">
                                            <div class="flex justify-center gap-1 sm:gap-2">
                                                <!-- View Button -->
                                                <button @click="viewModal = true; $nextTick(() => loadDokterDetail({{ $d->id }}))"
                                                ...
                                                <!-- Delete Button -->
                                                <form action="{{ route('admin.master-dokter.destroy', $d->id) }}" method="POST" class="form-hapus">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
                            ...
                            <div class="overflow-y-auto p-6 space-y-5">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-base font-semibold text-gray-800">
                                                <span class="px-3 py-1 bg-purple-500 text-white text-sm rounded-full" id="spesialisasi">
                                ...
                                <div class="bg-gradient-to-br from-teal-50 to-cyan-50 p-5 rounded-xl border-l-4 border-teal-500">
                                    ...
                                    <div class="flex items-center justify-between bg-white p-4 rounded-lg">
                                        ...
                                        <span class="px-4 py-2 bg-gradient-to-r from-red-500 to-red-600 text-white text-sm font-bold rounded-full shadow-lg flex items-center gap-2" id="status">
