                ...
                <div class="bg-[linear-gradient(to_bottom,#7134FC_0%,#2088FF_100%)] p-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-blue-100 text-sm">Perbaruhi Data Pasien dengan benar dan lengkap</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div x-show="editModal"
                        ...
                        <div @click.outside="editModal = false"
                            ...
                            <p class="text-gray-600 dark:text-gray-300 text-center mb-6">
                                Apakah Anda yakin ingin mengubah data pasien<br>
                                <strong class="text-gray-800 dark:text-white text-lg">Dagi sutoyo</strong>?
                            </p>
