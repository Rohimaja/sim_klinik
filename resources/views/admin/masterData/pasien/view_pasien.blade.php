                        ...
                        <tbody class="text-gray-700">
                            ...
                            @foreach ($pasien as $i => $d)
                                <tr class="border-b hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-3 sm:px-4 py-2 text-gray-600">{{ $d['umur'] }}</td>
                                    <td class="px-3 sm:px-4 py-2">{{ $d['jenis_kelamin'] }}</td>
                                    <td class="px-3 sm:px-4 py-2">{{ $d['alamat'] }}</td>
                                    ...
                                    <td class="px-3 sm:px-4 py-2 text-center" x-data="{ viewModal: false, deleteModal: false }">
                                        <div class="flex justify-center gap-1 sm:gap-2">
                                            ...
                                            <!-- Edit Button -->
                                            <a href="/admin/masterData/pasien/edit" 
