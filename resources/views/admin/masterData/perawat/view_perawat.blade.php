                        ...
                        <tbody class="text-gray-700">
                            ...
                            @foreach ($perawats as $i => $d)
                                <tr class="border-b hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-3 sm:px-4 py-2 text-gray-600">{{ $d['nira'] }}</td>
                                    <td class="px-3 sm:px-4 py-2">{{ $d['unit'] }}</td>
                                    ...
                                    <td class="px-3 sm:px-4 py-2 text-center" x-data="{ viewModal: false, deleteModal: false }">
                                        <div class="flex justify-center gap-1 sm:gap-2">
                                            ...
                                            <!-- Edit Button -->
                                            <a href="/admin/masterData/perawat/edit" 
