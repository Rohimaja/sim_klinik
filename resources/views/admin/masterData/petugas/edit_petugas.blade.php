                ...
                <div class="bg-[linear-gradient(to_bottom,#7134FC_0%,#2088FF_100%)] p-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-blue-100 text-sm">Perbaruhi Data Petugas Rekamedis dengan benar dan lengkap</p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select name="area_kerja" required
                                        ...
                                        <option value="Koding dan Indeksing" selected>Koding dan Indeksing (Klasifikasi Diagnosis dan Prosedur)</option>
