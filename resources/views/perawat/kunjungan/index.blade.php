<x-app-layout>
    @vite(['resources/js/pages/perawat/kunjungan.js'])
    <x-slot name="header">
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            @if ($k->skrining)
                                                {{-- Sudah Skrining --}}
                                                <a href="{{ route('perawat.kunjungan.edit', $k->skrining->id) }}"
                                            ...
                                            @else
                                                {{-- Belum Skrining --}}
                                                <form action="{{ route('perawat.kunjungan.panggil', $k->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    <button type="submit"
                ...
                <div @click.stop
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="border-t dark:border-gray-700 pt-4">
                            <p class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-2">Keluhan Awal:</p>
                            <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                                <p class="text-sm text-gray-900 dark:text-gray-100" id="keluhan_awal"></p>
                            </div>
                        </div>
