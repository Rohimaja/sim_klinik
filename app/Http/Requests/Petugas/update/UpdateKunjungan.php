...
class UpdateKunjungan extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        $id = $this->route('kunjungan');

        return [
            'nik' => ['required', 'max:16','regex:/^[0-9]+$/', Rule::unique('pasien', 'nik')->ignore($id),],
            'no_bpjs' => ['min:13','regex:/^[0-9]+$/',Rule::unique('pasien', 'no_bpjs')->ignore($id),],
