...
class UpdateMasterPetugas extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        $id = $this->route('master_petugas');

        return [
            'nama' => 'required|max:100|regex:/^[A-Za-z\s]+$/',
            'no_str' => ['max:20','regex:/^[A-Za-z0-9\s]+$/', Rule::unique('petugas','no_str')->ignore($id)],
            'no_sip' => ['max:50', Rule::unique('petugas','no_sip')->ignore($id)],
            'no_kta' => ['max:30', Rule::unique('petugas','no_kta')->ignore($id)],
            'jabatan' => 'required',
    ...
    public function messages(){
        return [
            ...
            'no_kta.max' => 'No Kartu Tanda Anggota maksimal 30 karakter',
            'no_kta.unique' => ' No Kartu Tanda Anggota sudah terdaftar',
