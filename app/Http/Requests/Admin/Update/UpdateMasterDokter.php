...
class UpdateMasterDokter extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        $id = $this->route('master_dokter');

        return [
            'poli_id' => 'required',
            'nama' => 'required|max:100|regex:/^[A-Za-z\s]+$/',
            'no_str' => ['max:20','regex:/^[A-Za-z0-9\s]+$/', Rule::unique('dokter','no_str')->ignore($id)],
            'no_sip' => ['max:50',Rule::unique('dokter','no_sip')->ignore($id)],
    ...
    public function messages(){
        return [
            ...
            'spesialisasi.required' => 'Silahkan Pilih Spesialisasi terlebih dahulu',
